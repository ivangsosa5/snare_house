...
const HeaderShop = () => {
  ...
  return (
    <div className='sticky top-28 z-10 flex flex-col bg-white'>
          <div className='flex h-16 w-full items-center bg-white mb-1'>
            <nav aria-label="Breadcrumb">
              <ol role="list" className="flex max-w-2xl items-center space-x-2 pl-2 sm:pl-11  lg:max-w-7xl ">
                  {brand !== undefined? <li>
            ...
            <div className='w-auto ml-auto pr-2 sm:pr-11 relative '>
              <Filters/>
              </div>
          </div>
