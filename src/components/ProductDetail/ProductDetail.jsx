...
function classNames(...classes) {
  ...
  const ProductDetail= ({producto})=>{
    ...
    return (
      ...
      <div className="pt-[134px] px-0 sm:px-16">
        ...
        <div className=" sm:max-w-4xl pb-16 lg:grid lg:max-w-full md:grid-cols-[1fr,1fr,1fr] lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:pb-24 pt-7 sm:grid-cols-2">
            
          <div className="aspect-[1/1] sm:px-2 md:w-[500px] flex items-center contrast-[92%] bg-white overflow-hidden">
          ...
          {/* Options */}
          <div className="px-4 sm:px-0 mt-4 lg:row-span-3 lg:col-span-2 lg:pl-6 lg:mt-0">
            <div className="pb-5">
            ...
            <div>
              ...
              <button
                onClick={'variantes' in producto ? selectedVariant.url != null? ()=>addItem({id:producto.id, name:producto.name, price:parseInt(producto.price), quantity:1, pictureUrl:selectedVariant.url, colorName: selectedVariant.colorName}) : ()=> alert('Por favor selecciona un color') : ()=>addItem({id:producto.id, name:producto.name, price:parseInt(producto.price), quantity:1, pictureUrl:producto.pictureUrl, colorName: producto.colorName})}
          ...
          <div className="px-4 sm:px-0 py-10 lg:col-span-2 lg:col-start-1 lg:pb-16 lg:pr-8 lg:pt-6">
